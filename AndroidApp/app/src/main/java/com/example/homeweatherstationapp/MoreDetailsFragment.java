...
public class MoreDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (!Firebase.error)
        {
            ...
            textView_avg_wind_speed.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateAverage(Firebase.LIST6)))) + " m/s");

            textView_max_str_temp.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST1)))) + " °C");
            textView_max_home_temp.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST7)))) + " °C");
            textView_max_str_hum.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST2)))) + " %");
            textView_max_home_hum.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST8)))) + " %");
            textView_max_rainfall.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST3)))) + " %");
            textView_max_wind_speed.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST6)))) + " m/s");
            textView_max_bat_charge.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMax(Firebase.LIST4)))) + " V");

            textView_min_str_temp.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST1)))) + " °C");
            textView_min_home_temp.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST7)))) + " °C");
            textView_min_str_hum.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST2)))) + " %");
            textView_min_home_hum.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST8)))) + " %");
            textView_min_rainfall.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST3)))) + " %");
            textView_min_wind_speed.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST6)))) + " m/s");
            textView_min_bat_charge.setText(Float.toString(Float.parseFloat(decimalFormat.format(calculateDetails.CalculateMin(Firebase.LIST4)))) + " V");

            CalculateDetails.Find_Wind_Direct_Percent(Firebase.LIST5);
